...
pub struct FpgaBitfileHmbDefs {
    pub HMB_0_LED: Option<ni_fpga::HmbDefinition>,
    pub HMB_0_RAM: Option<ni_fpga::HmbDefinition>,
}
pub struct FpgaBitfile {
    ...
    pub HMB_ReqReadyForInput:
        Option<ni_fpga::Register<bool, ni_fpga::ReadOnly, ni_fpga::StoredOffset>>,
    pub hmb_definitions: FpgaBitfileHmbDefs,
}
impl FpgaBitfile {
    pub fn take(session: &impl ni_fpga::SessionAccess) -> Result<Self, ni_fpga::Error> {
        ...
        Ok(Self {
            ...
            hmb_definitions: FpgaBitfileHmbDefs {
                HMB_0_LED: Some(ni_fpga::HmbDefinition {
                    name: "HMB_0_LED",
                    stride: 32,
                    elements: 524288,
                }),
                HMB_0_RAM: Some(ni_fpga::HmbDefinition {
                    name: "HMB_0_RAM",
                    stride: 32,
                    elements: 524288,
                }),
